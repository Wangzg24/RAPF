...
class FewRelDataset(data.Dataset):
    ...
    def __getrel__(self, item):
        # print(item) # [label_words, label_desc]
        # print(item)
        # breakpoint()
    ...
    def __getitem__(self, index):
        ...
        #     target_classes.append(self.classes[0*self.N + i])
        ...
        for i, class_name in enumerate(target_classes):
            ...
            #TODO
            rel_text, rel_text_mask = self.__getrel__(self.pid2name[class_name]) # 获取标签词和标签描述
